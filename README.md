# KR Engineering Backend Server

A Node.js/Express backend server for the KR Engineering website, built with TypeScript and using Bun as the runtime.
...
3. Configure environment variables:
   ...
   CONTACT_EMAIL=contact@krengineering.co.nz

   # Application Email (where job applications are sent)
   APPLICATION_SUBMISSION_EMAIL=hr@krengineering.co.nz
